    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('menu_time') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $menu->menus_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $menu->menus_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $menu->menus_id], ['confirm' => __('Are you sure you want to delete # {0}?', $menu->menus_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
