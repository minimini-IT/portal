...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $salonInformation->salon_informations_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $salonInformation->salon_informations_id)]
            )
        ?></li>
...
<div class="salonInformations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Salon Information') ?></legend>
        <?php
